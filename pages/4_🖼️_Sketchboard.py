...
response = requests.get('https://cdn.discordapp.com/attachments/738557702330122283/1078717809225379860/Screenshot_7.png')
bg_image = Image.open(io.BytesIO(response.content)).convert('RGB')
